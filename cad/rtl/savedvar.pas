...
begin
  ...
  TEdWND_Width:=1193;
  TEdWND_Height:=805;
  ProjectTreeWND_Left:=720;
  ProjectTreeWND_Top:=130;
  ProjectTreeWND_Width:=556;
  ProjectTreeWND_Height:=778;
  VIEW_CommandLineH:=82;
  VIEW_ObjInspV:=238;
  VIEW_ObjInspSubV:=129;
  PATH_File0:='E:\valsub\demo\test_stoiak.dxf';
  PATH_File1:='E:\zcad\cad\autosave\autosave.dxf';
  PATH_File2:='L:\nh\ДИЕВА проект2001\гостиница\ФОВ\proj.dxf';
  PATH_File3:='E:\zcad\cad\\sample\test_dxf\ops.dxf';
  PATH_File4:='E:\valsub\demo\test-superline.dxf';
  PATH_File5:='E:\zcad\cad\\sample\test_dxf\ops_arial.dxf';
  PATH_File6:='E:\zcad\cad\\sample\enttree\nonregular.dwg';
  PATH_File7:='E:\valsub\test1111.dxf';
  PATH_File8:='E:\valsub\test111(1).dxf';
  PATH_File9:='E:\zcad\cad\..\errors\ttf_error_with_calibri_font.dxf';
  UnitsWND_Left:=383;
  UnitsWND_Top:=91;
  UnitsWND_Width:=360;
  UnitsWND_Height:=450;
