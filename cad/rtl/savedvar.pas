...
begin
  ...
  VIEW_ObjInspV:=238;
  VIEW_ObjInspSubV:=118;
  PATH_File0:='E:\zcad\cad\autosave\autosave.dxf';
  PATH_File1:='E:\Alex\test_alex.dxf';
  PATH_File2:='L:\test_alex.dxf';
  PATH_File3:='L:\nh\термоинжиниринг\Садовый центр\котельная\изменения\изм2\ATM.dxf';
  PATH_File4:='E:\zcad\cad\\sample\test_dxf\truetype.dxf';
  PATH_File5:='L:\nh\ДИЕВА проект2001\270-20-2013-1\АОВ\изм\АОВ.dxf';
  PATH_File6:='L:\nh\термоинжиниринг\Садовый центр\котельная\ATM.dxf';
  PATH_File7:='L:\nh\ИНТЕРПРОЕКТДИЗАЙН\143\проект\АВК\avk.dxf';
  PATH_File8:='L:\nh\ИНТЕРПРОЕКТДИЗАЙН\143\проект\ПС\proj.dxf';
  PATH_File9:='L:\nh\ИНТЕРПРОЕКТДИЗАЙН\132\проект\ПС\proj.dxf';
  UnitsWND_Left:=383;
  UnitsWND_Top:=91;
  UnitsWND_Width:=360;
  UnitsWND_Height:=450;
