...
begin
  ...
  PATH_File1:='D:\temp\Rar$DIa0.329\ESCAL-dim-edrawing.DXF';
  PATH_File2:='D:\temp\Rar$DIa0.197\._ESCAL-no dim-librecad.DXF';
  PATH_File3:='E:\20lines.dxf';
  PATH_File4:='L:\nh\Коробова\Новоантипинский\АОВ.dxf';
  PATH_File5:='E:\zcad\cad\autosave\autosave.dxf';
  PATH_File6:='e:\zcad\cad\autosave\autosave.dxf';
  PATH_File7:='L:\nh\искандер\АБКГАРАЖ\Проект\АБК\АВК\АВК.dxf';
  PATH_File8:='L:\nh\искандер\АБКГАРАЖ\Проект\АБК\АОВ\AOB.dxf';
  PATH_File9:='L:\nh\искандер\АБКГАРАЖ\Проект\Гараж\АОВ\AOB.dxf';
  UnitsWND_Left:=383;
  UnitsWND_Top:=91;
  UnitsWND_Width:=360;
  UnitsWND_Height:=450;
