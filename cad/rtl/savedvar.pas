...
begin
  ...
  PATH_File4:='E:\Alex\test_alex.dxf';
  PATH_File5:='L:\test_alex.dxf';
  PATH_File6:='E:\zcad\cad\\sample\test_dxf\ops.dxf';
  PATH_File7:='L:\nh\Николай\театр\изм\Изм2\изм1гэ\plans.dxf';
  PATH_File8:='e:\zcad\cad\\sample\test_dxf\ops.dxf';
  PATH_File9:='D:\temp\Rar$DIa0.329\ESCAL-dim-edrawing.DXF';
  UnitsWND_Left:=383;
  UnitsWND_Top:=91;
  UnitsWND_Width:=360;
  UnitsWND_Height:=450;
