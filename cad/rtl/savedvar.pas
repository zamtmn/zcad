...
begin
  ...
  TEdWND_Width:=1193;
  TEdWND_Height:=805;
  ProjectTreeWND_Left:=1094;
  ProjectTreeWND_Top:=234;
  ProjectTreeWND_Width:=1176;
  ProjectTreeWND_Height:=778;
  VIEW_CommandLineH:=82;
  VIEW_ObjInspV:=238;
  VIEW_ObjInspSubV:=139;
  PATH_File0:='e:\zcad\cad\\sample\test_dxf\ops.dxf';
  PATH_File1:='E:\valsub\KVZ ПС планы - old 2015-11-29.dxf';
  PATH_File2:='E:\zcad\cad\sample\test_dxf\ops.dxf';
  PATH_File3:='E:\valsub\144_lines очистка типов линий.dxf';
  PATH_File4:='E:\valsub\144_lines.dxf';
  PATH_File5:='E:\valsub\ARK1.dxf';
  PATH_File6:='E:\valsub\KVZ.dxf';
  PATH_File7:='E:\valsub\KVZ ПС планы.dxf';
  PATH_File8:='e:\zcad\cad\autosave\autosave.dxf';
  PATH_File9:='L:\nh\ДИЕВА проект2001\гпшки\5\АОВ\AOB.dxf';
  UnitsWND_Left:=383;
  UnitsWND_Top:=91;
  UnitsWND_Width:=360;
  UnitsWND_Height:=450;
