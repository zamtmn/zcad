...
uses
  ...
  urtl,gdbentityfactory,zcadsysvars,strproc,gdbasetypes,commandline,log,UGDBOpenArrayOfPObjects,
  plugins,
  commandlinedef,
  commanddefinternal,
  gdbase,
...
begin
  ...
  historyout('Первый угол:');
  If assigned(SetGDBObjInspProc)then
  SetGDBObjInspProc(SysUnit.TypeName2PTD('CommandRTEdObject'),pco2);
