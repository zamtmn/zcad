...
begin
     ...
     result:=TypeOf^.CreateEditor(owner,x,y,w,h,pointer(pinstance^),nil)
end;
    ...
    if assigned(ta) then
                        begin
                             ...
                             if (PTUserTypeDescriptor(PUserTypeDescriptor((TypeOf)))^.GetTypeAttributes and TA_COMPOUND)=0 then
                                                                                                                        PTUserTypeDescriptor(PUserTypeDescriptor((TypeOf)))^.CreateProperties(PPDA,name,PCollapsed,ownerattrib,bmode,ta,valkey,valtype)
                                                                                                                    else
                                                                                                                    begin
                                                                                                                         ...
                                                                                                                         if (ppd^.SubNode=nil) then
                                                                                                                                                       begin
                                                                                                                                                       bm2:=-bmode;
                                                                                                                                                       PTUserTypeDescriptor(PUserTypeDescriptor((TypeOf)))^.CreateProperties(PPDA,name,PCollapsed,ownerattrib,bm2,ta,valkey,valtype);
                                                                                                                                                       bmode:=bm2;
                                                                                                                                                       end
                                                                                                                                                   else
                                                                                                                                                       begin
                                                                                                                                                            if (ppd^.valueAddres=nil)or(ppd^.valueAddres=ta) then
                                                                                                                                                                                       ...
                                                                                                                                                                                       begin
                                                                                                                                                                                            ...
                                                                                                                                                                                            bm2:=-bmode;
                                                                                                                                                                                            PTUserTypeDescriptor(PUserTypeDescriptor((TypeOf)))^.CreateProperties(PPDA,name,PCollapsed,ownerattrib,{bmode}bm2,ta,valkey,valtype);
                                                                                                                                                                                            bmode:=bm2;
                                                                                                                                                                                       end;
                                                                                                                                                       end;
