...
const str_empty='**EMPTY STRING**';
      ...
      lexemarray:array[0..maxlexem,0..1] of GDBString=(
                                                    ...
                                                    (('sym'),('?_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'#0)),
                                                    (('break'),('? '#13#10)),
                                                    (('softspace'),('[{_break'#0'}')),
                                                    (('endlexem'),('^ (['#13#10)),
                                                    (('softend'),('_softspace'#0'=;')),
                                                    (('hardspace'),('_break'#0'_softspace'#0)),
                                                    (('symordig'),('?_0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'#0)),
                                                    (('anysym'),('!@#$%^&*()[];:?_0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'#0)),
                                                    (('decdig'),('?0123456789'#0)),
                                                    (('sign'),('?+-'#0)),
