...
interface
uses
  paths,uzcsysvars,uzctranslations,uzcdrawing,uzeconsts,uzcstrconsts,plugins,
  uzccommandsabstract,
  uzccommandsimpl,
  gdbase,
  uzcdrawings,
  ...
  uzeentity,
  uzcshared,
  uzcdevicebaseabstract,UUnitManager,gdbasetypes,strutils,forms,Controls,zcadinterface,uzedrawingdef,UGDBStringArray,strmy,memman;

procedure DBLinkProcess(pEntity:PGDBObjEntity;const drawing:TDrawingDef);

implementation
uses uzcenitiesvariablesextender,uzcfsinglelinetexteditor,UObjectDescriptor,uzcfprojecttree,uzccommandsmanager,uzclog,uzeentsubordinated;
