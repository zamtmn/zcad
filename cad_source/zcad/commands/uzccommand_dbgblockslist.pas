...
function dbgBlocksList_com(const Context:TZCADCommandContext;
...
begin
  ...
  if pb<>nil then
    repeat
      zcUI.TextMessage(format('Found block "%s", contains %d entities',
        [Tria_AnsiToUtf8(pb^.Name),pb^.ObjArray.Count]),TMWOHistoryOut);
