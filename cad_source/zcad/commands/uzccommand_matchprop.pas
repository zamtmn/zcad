...
begin
  ...
  if commandmanager.getentity(rscmSelectSourceEntity,ps)=GRNormal then begin
    ...
    while commandmanager.getentity(rscmSelectDestinationEntity,pd)=GRNormal do begin
