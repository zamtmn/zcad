...
resourcestring
  //RSCLPRotateWaitBasePoint='Specify base point:';
...
var
  p1:TzePoint3d;
  BasePnt,R0Pnt,R1Pnt,A0Pnt,A1Pnt:TzePoint3d;
  ...
  begin
    ...
    case ANewMode of
      RCMWaitBasePoint:begin
        commandmanager.SetPrompt({RSCLPRotateWaitBasePoint}rscmBasePoint);
...
initialization
  ...
  RefV:=CreateVector(1,0,0);
  Axis:=CreateVector(0,0,1);
  CreateZCADCommand(@Rotate_com,'Rotate2',CADWG,0);
