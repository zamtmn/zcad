...
function SelObjChangeLayerToCurrent_com(const Context:TZCADCommandContext;
...
initialization
  ...
  CreateZCADCommand(@SelObjChangeLayerToCurrent_com,
    'SelObjChangeLayerToCurrent',CADWG,0);
