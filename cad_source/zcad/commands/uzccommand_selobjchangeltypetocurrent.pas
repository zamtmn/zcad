...
function SelObjChangeLTypeToCurrent_com(const Context:TZCADCommandContext;
...
initialization
  ...
  CreateZCADCommand(@SelObjChangeLTypeToCurrent_com,
    'SelObjChangeLTypeToCurrent',CADWG,0);
