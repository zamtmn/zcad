...
{$INCLUDE def.inc}
interface
uses UGDBOpenArrayOfPObjects,uzcsysvars,geometry,uzglviewareaabstract,paths,uzectsconsts,uzcctrldynamiccommandmenu,uzcinfoform,uzcstrconsts,{umytreenode,}uzcsysinfo,strproc,UGDBOpenArrayOfPointer,
