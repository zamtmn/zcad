...
begin
  ...
  units.loadunit(GetSupportPaths,InterfaceTranslate,expandpath('$(DistroPath)/rtl/objcalc/opsmarkdef.pas'),(@defaultunit));
             ...
             if ptn<>nil then
                repeat
                    ...
                    begin
                         ...
                         units.loadunit(GetSupportPaths,InterfaceTranslate,expandpath('$(DistroPath)/rtl/objcalc/opsmark.pas'),(currentunit));
