...
uses
  ...
  uzctranslations,zeentitiesmanager,GDBEntity,uzglabstractviewarea,gdbdrawcontext,GDBAbstractText,GDBText,UGDBStringArray,zeentityfactory,uzcsysvars,strproc,gdbasetypes,uzccommandsmanager,uzclog,UGDBOpenArrayOfPObjects,
  plugins,
  uzccommandsabstract,
  uzccommandsimpl,
  gdbase,
...
implementation
uses uzcenitiesvariablesextender,GDBRoot,uzglviewareadata, gdbcable,UUnitManager,GDBCommandsElectrical,{UGDBObjBlockdefArray,}URecordDescriptor,TypeDescriptors;
