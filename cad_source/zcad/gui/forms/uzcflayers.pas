...
uses
  zcchangeundocommand,zcobjectchangeundocommand2,uzedrawing,uzepalette,uzcsuptypededitors,LMessages,uzcfselector,uzestyleslinetypes,uzeutils,uzclog,uzcflineweights,uzcfcolors,uzedrawingsimple,uzcsysvars,Classes, SysUtils,
  FileUtil, LResources, Forms, Controls, Graphics, Dialogs,GraphType,
  Buttons, ExtCtrls, StdCtrls, ComCtrls,LCLIntf,lcltype, ActnList,

  gdbobjectsconstdef,uzestyleslayers,uzcdrawings,gdbase,gdbasetypes,varmandef,
