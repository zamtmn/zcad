...
interface
uses
 uzcsysvars,uzctranslations,uzcenitiesvariablesextender,ugdbdrawing,paths,UGDBStringArray,gdbobjectsconstdef,uzcstrconsts,ucxmenumgr,strproc,umytreenode,menus, {$IFDEF FPC}lcltype,{$ENDIF}
