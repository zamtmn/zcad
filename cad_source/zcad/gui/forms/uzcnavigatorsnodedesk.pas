...
var
  ...
  BracketTockenId,TestId,StringId:EntityFilterParser.TParserTokenizer.TTokenId;
  //InBracketParser:TEntityFilterParser;
...
procedure TGetEntParam.GetResult(const Source:GString;
                    const Token :TSubStr;
                    const Operands :TSubStr;
                    const ParsedOperands:TAbstractParsedText{<GString,GDataType>};
                    var Result:GString;
                    var ResultParam:TSubStr;
                    const data:GDataType);
var
  i:integer;
...
constructor TGetEntParam.vcreate(const Source:GString;
                        const Token :TSubStr;
                        const Operands :TSubStr;
                        const ParsedOperands:TAbstractParsedText{<GString,GDataType>};
                        const Data:{TEntsTypeFilter}pointer);
...
class procedure TEntityFilterString.StaticGetResult(const Source:GString;
                                      const Token :TSubStr;
                                      const Operands :TSubStr;
                                      const ParsedOperands:TAbstractParsedText{<GString,GDataType>};
                                      var Result:GString;
...
initialization
  //InBracketParser:=TEntityFilterParser.create;
  //InBracketParser.RegisterToken('''','''','''',TIncludeEntityNameMask,nil,[TOIncludeBrackeOpen]);
  //InBracketParser.RegisterToken(',',#0,#0,TIncludeEntityNameMask,nil,[TOIncludeBrackeOpen]);
  //InBracketParser.RegisterToken(' ',#0,#0,TIncludeEntityNameMask,nil,[TOIncludeBrackeOpen]);

  EntityIncluderParser:=TEntityIncluderParser.create;
  BracketTockenId:=EntityIncluderParser.RegisterToken('(','(',')',TIncludeEntityNameMask,EntityIncluderParser,[TONestedBracke,TOIncludeBrackeOpen,TOSeparator]);
  ...
  StringId:=EntityFilterParser.RegisterToken('''','''','''',TEntityFilterString,nil,[TOIncludeBrackeOpen]);
