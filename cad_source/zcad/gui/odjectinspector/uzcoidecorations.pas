...
uses
  ...
  gzctnrvectortypes,uzbgeomtypes,uzcinterface,uzcoimultiobjects,uzcgui2color,uzcgui2linewidth,uzcgui2linetypes;
type
...
begin
     ...
     AddEditorToType(SysUnit.TypeName2PTD('GDBDouble'),TBaseTypesEditors.BaseCreateEditor);
