...
begin
  ...
  MultiPropertiesManager.RegisterMultiproperty('OSnapMode','OSnap mode',sysunit^.TypeName2PTD('TOSnapMode'),MPCGeneral,0,integer(@pent^.vp.OSnapMode),integer(@pent^.vp.OSnapMode),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
