...
begin
  ...
  MultiPropertiesManager.RegisterMultiproperty('OSnapMode','OSnap mode',sysunit^.TypeName2PTD('TOSnapMode'),MPCGeneral,0,integer(@pent^.OSnapMode),integer(@pent^.OSnapMode),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
