...
begin
  ...
  MultiPropertiesManager.RegisterPhysMultiproperty('EXTDRSSMARTTEXTENT_TextHeight','Height override',sysunit^.TypeName2PTD('Double'),MPCExtenders,0,TSmartTextEntExtender,PtrInt(@SmartTextEntExtender.FHeightOverride),PtrInt(@SmartTextEntExtender.FHeightOverride),OneVarDataMIPD,OneVarDataEIPD);
