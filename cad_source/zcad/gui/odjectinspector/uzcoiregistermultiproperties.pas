...
begin
  ...
  MultiPropertiesManager.RegisterMultiproperty('LControl_BadLayer','LC bad layer',sysunit^.TypeName2PTD('GDBString'),MPCExtenders,0,TLayerControlExtender,integer(@LayerControlExtender.BadLayer),integer(@LayerControlExtender.BadLayer),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
  MultiPropertiesManager.RegisterMultiproperty('LControl_VarName','LC variable name',sysunit^.TypeName2PTD('GDBString'),MPCExtenders,0,TLayerControlExtender,integer(@LayerControlExtender.VariableName),integer(@LayerControlExtender.VariableName),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
  MultiPropertiesManager.RegisterMultiproperty('LControl_Inverse','LC inverse',sysunit^.TypeName2PTD('GDBBoolean'),MPCExtenders,0,TLayerControlExtender,integer(@LayerControlExtender.Inverse),integer(@LayerControlExtender.Inverse),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
  {General section}
