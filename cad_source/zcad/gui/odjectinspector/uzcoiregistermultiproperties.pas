...
begin
  ...
  MultiPropertiesManager.RegisterMultiproperty('OSnapMode','OSnap mode',sysunit^.TypeName2PTD('TOSnapMode'),MPCGeneral,0,integer(@pent^.OSnapModeControl),integer(@pent^.OSnapModeControl),@GetOneVarData,@FreeOneVarData,nil,@GeneralEntIterateProc,@GeneralFromVarEntChangeProc);
