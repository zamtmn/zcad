...
uses
  ...
  {FPC}
       lineinfo,
  {ZCAD BASE}
       uzcgui2color,uzcgui2linewidth,uzcgui2linetypes,zemathutils,uzelongprocesssupport,gluinterface,uzgldrawergdi,uzedrawing,UGDBOpenArrayOfPV,uzedrawingabstract,gdbpalette,paths,uzglviewareadata,gdbvisualprop,uzglgeometry,zcadinterface,plugins,UGDBOpenArrayOfByte,memman,gdbase,gdbasetypes,
  ...
  {ZCAD ENTITIES}
       ...
       GDBBlockDef,UGDBDescriptor,GDBManager,uzestyleslinetypes,gdbobjectsconstdef,uzeenttext,uzeentdimension,
  {ZCAD COMMANDS}
