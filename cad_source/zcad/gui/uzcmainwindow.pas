...
uses
  ...
  {FPC}
       lineinfo,
  {ZCAD BASE}
       uzcgui2color,uzcgui2linewidth,uzcgui2linetypes,zemathutils,uzelongprocesssupport,gluinterface,uzgldrawergdi,uzedrawing,UGDBOpenArrayOfPV,uzedrawingabstract,uzepalette,paths,uzglviewareadata,uzeentitiesprop,uzglgeometry,zcadinterface,plugins,UGDBOpenArrayOfByte,memman,gdbase,gdbasetypes,
  ...
  {ZCAD ENTITIES}
       ...
       uzeblockdef,uzcdrawings,uzcutils,uzestyleslinetypes,uzectsconsts,uzeenttext,uzeentdimension,
  {ZCAD COMMANDS}
