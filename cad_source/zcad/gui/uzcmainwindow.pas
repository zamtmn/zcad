...
uses
  ...
  {FPC}
       lineinfo,
  {ZCAD BASE}
       uzcgui2color,uzcgui2linewidth,uzcgui2linetypes,zemathutils,uzelongprocesssupport,uzegluinterface,uzgldrawergdi,uzcdrawing,UGDBOpenArrayOfPV,uzedrawingabstract,uzepalette,paths,uzglviewareadata,uzeentitiesprop,uzglgeometry,uzcinterface,UGDBOpenArrayOfByte,memman,gdbase,gdbasetypes,
