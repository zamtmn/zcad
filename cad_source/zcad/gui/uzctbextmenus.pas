...
begin
  ...
  FromDirIterator(expandpath('$(ZDataPath)//examples'),'*.dxf','',@bugfileiterator,nil);
  FromDirIterator(expandpath('$(ZDataPath)//examples'),'*.dwg','',@bugfileiterator,nil);
  localpm.localpm:=nil;
...
begin
  localpm.localpm:=RootMenuItem;
  localpm.ImageIndex:=ImagesManager.GetImageIndex('Dxf');
  FromDirIterator(expandpath('$(ZDataPath)/../errors/'),'*.dxf','',@bugfileiterator,nil);
  localpm.localpm:=nil;
  localpm.ImageIndex:=-1;
end;
