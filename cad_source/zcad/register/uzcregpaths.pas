...
initialization
  ...
  units.CreateExtenalSystemVariable(SysVarUnit,SysVarN,GetSupportPath,expandpath('$(ZCADPath)/rtl/system.pas'),InterfaceTranslate,'PATH_Dictionaries','String',@SysVar.PATH.Dictionaries);
