...
initialization;
     ...
     if SysUnit=nil then
       begin
         units.loadunit(GetSupportPath,InterfaceTranslate,expandpath('$(ZDataPath)/rtl/system.pas'),nil);
         SysUnit:=units.findunit(GetSupportPath,InterfaceTranslate,'System');
       end;
