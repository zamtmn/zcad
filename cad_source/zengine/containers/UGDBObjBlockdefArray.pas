...
{$INCLUDE def.inc}
interface
uses LCLProc,uzgldrawcontext,uzedrawingdef,uzbstrproc,uzeblockdef,gzctnrvectordata,
...
GDBObjBlockdefArray={$IFNDEF DELPHI}packed{$ENDIF} object(GZVectorData{-}<GDBObjBlockdef>{//})(*OpenArrayOfData=GDBObjBlockdef*)
