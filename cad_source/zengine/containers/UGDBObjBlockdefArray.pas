...
{$INCLUDE def.inc}
interface
uses LCLProc,uzgldrawcontext,uzedrawingdef,uzbstrproc,uzeblockdef,uzctnrvectordata,
...
GDBObjBlockdefArray={$IFNDEF DELPHI}packed{$ENDIF} object(TZctnrVectorData{-}<GDBObjBlockdef>{//})(*OpenArrayOfData=GDBObjBlockdef*)
