...
{$INCLUDE def.inc}
interface
uses LCLProc,uzgldrawcontext,uzedrawingdef,uzbstrproc,uzeblockdef,uzctnrvectorrec,
...
GDBObjBlockdefArray={$IFNDEF DELPHI}packed{$ENDIF} object(TZctnrVectorRec{-}<GDBObjBlockdef>{//})(*OpenArrayOfData=GDBObjBlockdef*)
