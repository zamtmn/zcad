...
uses
  ...
  uzestyleslayers,uzedrawingdef,uzbstrproc,uzctnrVectorBytesStream,uzegeometry,
  SysUtils,uzeentity,uzbtypes,uzeTypes,uzeconsts,uzeffdxfsupport,uzeentsubordinated,
