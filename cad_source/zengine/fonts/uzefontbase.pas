...
type
  ...
  TZEBaseFontImpl=class
    ...
    public
      ...
      procedure SetupSymbolLineParams(const matr:TzeTypedMatrix4d; var SymsParam:TSymbolSParam);virtual;
...
implementation
procedure TZEBaseFontImpl.SetupSymbolLineParams(const matr:TzeTypedMatrix4d; var SymsParam:TSymbolSParam);
begin
end;
