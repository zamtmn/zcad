                  ...
                  007:
                    begin
                      ...
                      begin
                        ...
                        pf^.font.FontData.MulOnMatrix(VDCopyResultParam.EID.GeomIndexMin,VDCopyResultParam.EID.GeomIndexMax,MatrixMultiply(CreateScaleMatrix(TzeVector3d.Make(baselen*TZESHXFontImpl(pf^.font).h,baselen*TZESHXFontImpl(pf^.font).h,1)),CreateTranslationMatrix(TzeVector3d.Make(x,y,0))));
