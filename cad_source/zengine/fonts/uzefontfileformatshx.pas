...
uses uzgprimitivescreator,uzglvectorobject,uzefontmanager,uzefontshx,uzegeometry,
     uzefont,FileUtil,math,sysutils,
                  ...
                  007:
                    begin
                      ...
                      begin
                        ...
                        pf^.font.FontData.MulOnMatrix(VDCopyResultParam.EID.GeomIndexMin,VDCopyResultParam.EID.GeomIndexMax,MatrixMultiply(CreateScaleMatrix(TzeVector3d.CreateRec(baselen*TZESHXFontImpl(pf^.font).h,baselen*TZESHXFontImpl(pf^.font).h,1)),CreateTranslationMatrix(TzeVector3d.CreateRec(x,y,0))));
