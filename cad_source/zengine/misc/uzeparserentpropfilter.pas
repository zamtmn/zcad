...
initialization
  ...
  BracketTockenId:=ParserEntityPropFilter.RegisterToken('(','(',')',nil,ParserEntityPropFilter,__TONestedBracke or __TOIncludeBrackeOpen or __TOSeparator);
  ParserEntityPropFilter.RegisterToken('IncludeIfMask',#0,#0,TIncludeIfMask,ParserEntityPropFilter,__TOWholeWordOnly,BracketTockenId);
  ParserEntityPropFilter.RegisterToken('SameMask',#0,#0,TSameMask,ParserEntityPropFilter,__TOWholeWordOnly,BracketTockenId);
  ParserEntityPropFilter.RegisterToken('Or',#0,#0,TOr,ParserEntityPropFilter,__TOWholeWordOnly,BracketTockenId);
  ParserEntityPropFilter.RegisterToken('IncludeIfSame',#0,#0,TIncludeIf,ParserEntityPropFilter,__TOWholeWordOnly,BracketTockenId);
  ParserEntityPropFilter.RegisterToken('%%',#0,#0,TGetEntParam,ParserEntityPropFilter,__TOWholeWordOnly,BracketTockenId);
  ParserEntityPropFilter.RegisterToken('''','''','''',ParserEntityPropFilter.TParserTokenizer.TStringProcessor,nil,__TOIncludeBrackeOpen);
  ParserEntityPropFilter.RegisterToken(',',#0,#0,nil,nil,__TOSeparator);
  ParserEntityPropFilter.RegisterToken(';',#0,#0,nil,nil,__TOSeparator);
  ParserEntityPropFilter.RegisterToken(' ',#0,#0,nil,nil,__TOSeparator or __TOCanBeOmitted);
  ParserEntityPropFilter.RegisterToken(#10,#0,#0,nil,nil,__TOSeparator or __TOCanBeOmitted);
  ParserEntityPropFilter.RegisterToken(#13,#0,#0,nil,nil,__TOSeparator or __TOCanBeOmitted);
finalization;
