...
initialization
  ...
  ParserEntityPropFilter.RegisterToken('SameMask',#0,#0,TSameMask,ParserEntityPropFilter,[TOWholeWordOnly],BracketTockenId);
  ParserEntityPropFilter.RegisterToken('Or',#0,#0,TOr,ParserEntityPropFilter,[TOWholeWordOnly],BracketTockenId);
  ParserEntityPropFilter.RegisterToken('IncludeIfSame',#0,#0,TIncludeIf,ParserEntityPropFilter,[TOWholeWordOnly],BracketTockenId);
