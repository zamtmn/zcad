...
begin
     ...
     if LCS.notuseLCS then
                      ...
                      begin
                           t:=TzePoint3d.Make(PzePoint2i(v)^.x,PzePoint2i(v)^.y,0)+LCS.CurrentCamCSOffset;
                           glVertex3dV(@t);
                      end;
end;
...
begin
     ...
     if LCS.notuseLCS then
                      ...
                      begin
                           t:=TzePoint3d.Make(x,y,0)+LCS.CurrentCamCSOffset;
                           glVertex3dV(@t);
                      end;
end;
...
begin
     ...
     if LCS.notuseLCS then
                      ...
                      begin
                           t:=TzePoint3d.Make(PzePoint2d(v)^.x,PzePoint2d(v)^.y,0)+LCS.CurrentCamCSOffset;
                           glVertex3dV(@t);
                      end;
end;
...
oglsm.myglbegin(GL_LINES);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMin.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMin.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMin.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMax.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMax.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMax.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMax.y,BoundingBox.pMin.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMin.y,BoundingBox.pMin.Z);
oglsm.myglend();
oglsm.myglbegin(GL_LINES);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMin.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMin.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMin.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMax.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMax.x,BoundingBox.pMax.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMax.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMax.y,BoundingBox.pMax.Z);
   oglsm.myglVertex(BoundingBox.pMin.x,BoundingBox.pMin.y,BoundingBox.pMax.Z);
oglsm.myglend();
oglsm.myglbegin(GL_LINES);
