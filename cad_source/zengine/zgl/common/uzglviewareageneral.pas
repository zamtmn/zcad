    ...
    public
      class var ShowCursorHandlersVector:TShowCursorHandlersVector;
                       ...
                       var WorkArea:TCADControl;
                           ...
                           procedure RotTo(x0,y0,z0:TzeVector3d);override;
...
var
  i, j: Integer;
  pt:ptraceprop;
  mvertex,tv1,tv2,sv1,d1:TzePoint3d;
  dvertex:TzeVector3d;
...
begin
  ...
  begin
    ...
    PDWG.Getpcamera^.Counters.totalobj:=0;
    PDWG.Getpcamera^.Counters.infrustum:=0;
...
begin
  ...
  PDWG.Getpcamera.DRAWNOTEND:=treerender(PDWG.GetCurrentROOT^.ObjArray.ObjTree,now(),rc);
  drawer.SaveBuffers;
  showcursor(rc);
  SwapBuffers(rc);
end;
...
procedure TGeneralViewArea.RotTo(x0,y0,z0:TzeVector3d);
const
     steps=10;
var
  fv1: TzePoint3d;
...
{  for I := 0 to 5 do
  ...
  pdwg.GetSelObjArray.calcvisible(pdwg.Getpcamera^.frustum,Actlt,pdwg.getpcamera.Counters,pdwg.myGluProject2,pdwg.getpcamera.prop.zoom,SysVarRDImageDegradationCurrentDegradationFactor);
  Set3dmouse;
  CorrectMouseAfterOS;
  draworinvalidate;
end;
