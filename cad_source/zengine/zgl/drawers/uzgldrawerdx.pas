...
uses
    ...
    uzegeometrytypes,uzbtypesbase,uzecamera;
const
  texturesize=128;
type
{EXPORT+}
...
implementation
//uses log;
procedure TZGLDXDrawer.pushMatrixAndSetTransform(Transform:DMatrix4D);
begin
  oglsm.myglPushMatrix;
  oglsm.myglMultMatrixD(Transform);
end;
procedure TZGLDXDrawer.pushMatrixAndSetTransform(Transform:DMatrix4F);
begin
  oglsm.myglPushMatrix;
