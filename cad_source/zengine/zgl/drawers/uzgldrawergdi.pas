...
interface
uses
    sysutils,gdbasetypes,uzgldrawergeneral2d,lclintfex,fileutil,math,uzefontmanager,uzefont,{zcadsysvars,}uzglviewareaabstract,{$IFNDEF DELPHI}LazUTF8,{$ENDIF}uzglgeomdata,gdbdrawcontext,uzgprimitives,uzgprimitivescreatorabstract,uzgprimitivescreator,UGDBOpenArrayOfData,gdbpalette,
    ...
    Classes,Controls,
    geometry,uzgldrawergeneral,uzgldrawerabstract,glstatemanager,Graphics,gdbase;
const
