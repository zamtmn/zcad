...
{$INCLUDE def.inc}
interface
uses uzgprimitivescreatorabstract,uzgprimitivescreator,UGDBOpenArrayOfData,uzgldrawerabstract,gdbpalette,types,Classes,Graphics,gdbase,gdbasetypes,GDBCamera,geometry;
type
