unit DEVICE_VEL_SOCKET_BOXJUNCTION;
...
BTY_TreeCoord:='PLAN_VEL_Коробка вводная проходная';
...
realnamedev:='Коробка вводная/проходная';
Power:=0.0;
CosPHI:=1.0;
...
VSPECIFICATION_Name:='Коробка вводная/проходная';
