unit DEVICE_VEL_SOCKET_CABLETERMINATION;
...
BTY_TreeCoord:='PLAN_VEL_Концевая кабельная муфта';
...
realnamedev:='Концевая кабельная муфта';
Power:=0.0;
CosPHI:=1.0;
...
VSPECIFICATION_Name:='Концевая кабельная муфта';
