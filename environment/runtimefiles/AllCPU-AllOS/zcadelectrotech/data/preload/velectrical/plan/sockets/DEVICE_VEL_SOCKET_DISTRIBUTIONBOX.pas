unit DEVICE_VEL_SOCKET_DISTRIBUTIONBOX;
...
BTY_TreeCoord:='PLAN_VEL_Коробка ответвительная';
...
realnamedev:='Коробка ответвительная';
Power:=0.0;
CosPHI:=1.0;
...
VSPECIFICATION_Name:='Коробка ответвительная';
