unit DEVICE_VEL_SOCKET_ELFUNNELDRAIN;
...
BTY_TreeCoord:='PLAN_VEL_Электрическая воронка с гр кабелем';
...
realnamedev:='Электрическая воронка с гр кабелем';
Power:=500.0;
CosPHI:=1.0;
...
VSPECIFICATION_Name:='Электрическая воронка с гр кабелем';
