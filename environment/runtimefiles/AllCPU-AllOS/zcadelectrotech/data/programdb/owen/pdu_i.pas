...
begin
     ...
     _EQ_OWEN_PDU_I.NameShortTemplate:='ПДУ-И.%%[Limers].%%[Discr]';
     _EQ_OWEN_PDU_I.NameTemplate:='Поплавковый уровнемер ПДУ-И.%%[Limers].%%[Discr]';
     ...
     _EQ_OWEN_PDU_I.TreeCoord:='BP_ОВЕН_Поплавковый уровнемер_ПДУ-И|BC_Оборудование автоматизации_Поплавковый уровнемер_ПДУ-И(ОВЕН)';
