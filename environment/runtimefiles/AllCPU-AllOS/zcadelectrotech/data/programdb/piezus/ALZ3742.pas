...
begin
     ...
     _EQ_PIEZUS_ALZ3742.NameFullTemplate:='Погружной гидростатический датчик уровня, верхний предел измерений 10м, основная погрешность 0.5%, выходной сигнал 4-20мА, уплотнение фторкаучук, корпус PVC, исполнение стандартное, оболочка кабеля PVC, длина кабеля 10м%%[Comment]';
