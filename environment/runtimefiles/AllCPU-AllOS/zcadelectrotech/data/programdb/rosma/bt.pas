...
type
  ...
  TRosmaBT_32_211=packed object(TRosmaBT_31_211);
  end;
  TRosmaBT_52_211=packed object(TRosmaBT_31_211);
  end;
...
var
  ...
  _EQ_RosmaBT_32_211:TRosmaBT_32_211;
  _EQ_RosmaBT_52_211:TRosmaBT_52_211;
...
begin
  ...
  _EQ_RosmaBT_31_211.NameFullTemplate:='Термометр биметаллический, осевое присоединение, диаметра корпуса 63мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  ...
  _EQ_RosmaBT_41_211.NameFullTemplate:='Термометр биметаллический, осевое присоединение, диаметра корпуса 80мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  ...
  _EQ_RosmaBT_51_211.NameFullTemplate:='Термометр биметаллический, осевое присоединение, диаметра корпуса 100мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  ...
  _EQ_RosmaBT_71_211.NameFullTemplate:='Термометр биметаллический, осевое присоединение, диаметра корпуса 150мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  ...
  _EQ_RosmaBT_32_211.initnul;

  _EQ_RosmaBT_32_211.L:=_100;
  _EQ_RosmaBT_32_211.Shkala:=_00_120;
  _EQ_RosmaBT_32_211.Rzb:=_M20x1_5;
  _EQ_RosmaBT_32_211.Prec:=_1_5;

  _EQ_RosmaBT_32_211.Group:=_thermometer;
  _EQ_RosmaBT_32_211.EdIzm:=_sht;
  _EQ_RosmaBT_32_211.ID:='RosmaBT_32_211';
  _EQ_RosmaBT_32_211.Standard:='ТУ 4211-001-4719015564-2008';
  _EQ_RosmaBT_32_211.OKP:='';
  _EQ_RosmaBT_32_211.Manufacturer:='ЗАО «РОСМА» г.Санкт-Петербург';

  _EQ_RosmaBT_32_211.Description:=BT21desc;
  _EQ_RosmaBT_32_211.NameShortTemplate:='БТ-32.211(%%[Shkala]°C)%%[Rzb].%%[L].%%[Prec]';
  _EQ_RosmaBT_32_211.NameTemplate:='Термометр биметаллический %%c63мм с гильзой, радиальное присоединение, %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм';
  _EQ_RosmaBT_32_211.NameFullTemplate:='Термометр биметаллический, радиальное присоединение, диаметра корпуса 63мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  _EQ_RosmaBT_32_211.UIDTemplate:='БТ-32.211(%%[Shkala]°C)%%[Rzb].%%[L].%%[Prec]';
  _EQ_RosmaBT_32_211.TreeCoord:='BP_РОСМА_Термометры_БТ|BC_Оборудование автоматизации_Термометры_БТ(Росма)';
  _EQ_RosmaBT_32_211.format;


  _EQ_RosmaBT_52_211.initnul;

  _EQ_RosmaBT_52_211.L:=_100;
  _EQ_RosmaBT_52_211.Shkala:=_00_120;
  _EQ_RosmaBT_52_211.Rzb:=_M20x1_5;
  _EQ_RosmaBT_52_211.Prec:=_1_5;

  _EQ_RosmaBT_52_211.Group:=_thermometer;
  _EQ_RosmaBT_52_211.EdIzm:=_sht;
  _EQ_RosmaBT_52_211.ID:='RosmaBT_52_211';
  _EQ_RosmaBT_52_211.Standard:='ТУ 4211-001-4719015564-2008';
  _EQ_RosmaBT_52_211.OKP:='';
  _EQ_RosmaBT_52_211.Manufacturer:='ЗАО «РОСМА» г.Санкт-Петербург';

  _EQ_RosmaBT_52_211.Description:=BT21desc;
  _EQ_RosmaBT_52_211.NameShortTemplate:='БТ-52.211(%%[Shkala]°C)%%[Rzb].%%[L].%%[Prec]';
  _EQ_RosmaBT_52_211.NameTemplate:='Термометр биметаллический %%c100мм с гильзой, радиальное присоединение, %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм';
  _EQ_RosmaBT_52_211.NameFullTemplate:='Термометр биметаллический, радиальное присоединение, диаметра корпуса 100мм, диапазон измерений %%[Shkala]°C, резьба гильзы %%[Rzb], длина погружаемой части %%[L]мм, класс точности %%[Prec], с латунной гильзой';
  _EQ_RosmaBT_52_211.UIDTemplate:='БТ-52.211(%%[Shkala]°C)%%[Rzb].%%[L].%%[Prec]';
  _EQ_RosmaBT_52_211.TreeCoord:='BP_РОСМА_Термометры_БТ|BC_Оборудование автоматизации_Термометры_БТ(Росма)';
  _EQ_RosmaBT_52_211.format;
