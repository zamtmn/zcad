...
begin
  ...
  DSGN_LCNet.LayerName:=DecodeStringBase64('REVGUE9JTlRT');
  DSGN_LCCable.Enabled:=True;
  DSGN_LCCable.LayerName:=DecodeStringBase64('RUxfS0FCTEU=');
  DSGN_LCLeader.Enabled:=True;
  DSGN_LCLeader.LayerName:=DecodeStringBase64('VEVYVA==');
  ...
  RD_Vendor:=DecodeStringBase64('');
  RD_Renderer:=DecodeStringBase64('');
  RD_Extensions:=DecodeStringBase64('');
  RD_Version:=DecodeStringBase64('NC4zLjA=');
  ...
  PATH_LayoutFile:=DecodeStringBase64('JChaQ0FEUGF0aCkvZGVmYXVsdGxheW91dC54bWw=');
end.