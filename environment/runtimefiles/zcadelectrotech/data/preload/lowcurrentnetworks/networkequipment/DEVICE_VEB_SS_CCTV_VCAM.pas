...
BTY_TreeCoord:='PLAN_VEB_LAN_CCTV_IP камера внутренняя цилиндр';
...
VSPECIFICATION_Name:='IP камера внутренняя цилиндр';
...
VSPECIFICATION_Note:='';
VSPECIFICATION_Grouping:='Видеонаблюдение';
