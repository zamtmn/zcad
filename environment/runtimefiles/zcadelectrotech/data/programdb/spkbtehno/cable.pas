...
TSPKBTEHNO_TEHNOKIPNGAFRLS_WCS=(_1_2_0_2(*'1х2х0.20'*),
                                _1_2_0_35(*'1х2х0.35'*),
                                _1_2_0_5(*'1х2х0.50'*),
                                _1_2_0_75(*'1х2х0.75'*),
                                _1_2_1_0(*'1х2х1.00'*),
...
begin
     ...
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.EdIzm:=_m;
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.ID:='SPKBTEHNO_TEHNOKIPNGAFRLS';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.Standard:='ТУ 3574-014-53930360-2013';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.OKP:='35 7400';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.Manufacturer:='ЗАО "СПКБ Техно" г.Подольск';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.Description:='Кабель огнестойкий, интерфейсный симметричной парной скрутки с низким значением погонной емкости предназначен для высокоскоростной передачи и приема данных в системах противопожарной защиты, построенных по промышленному интерфейсу RS-485 в соответствии со стандартами ИСО/МЭК 8482, TIA/EIA RS-485-A, на промышленных интерфейсах CAN, HART и других,а также в других системах  связи, контроля и управления, которые должны сохранять работоспособность в течение 180 минут в условиях воздействия открытого пламени.';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.NameShortTemplate:='ТехноКИПнг(А)-FRLS %%[Wire_Count_Section_DESC]';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.NameTemplate:='Кабель огнестойкий, интерфейсный симметричной парной скрутки  с низким значением погонной емкости ТехноКИПнг(А)-FRLS %%[Wire_Count_Section_DESC]';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.UIDTemplate:='%%[ID]-%%[Wire_Count_Section_DESC]';
     _EQ_SPKBTEHNO_TEHNOKIPNGAFRLS.NameFullTemplate:='Кабель огнестойкий, интерфейсный симметричной парной скрутки  с низким значением погонной емкости ТехноКИПнг(А)-FRLS %%[Wire_Count_Section_DESC]';
