unit DEVICE_VEL_SWITCH_1PP31IN;
...
BTY_TreeCoord:='PLAN_VEL_Освещение_Выключатель встраиваемый проходной СП31 1Р';
...
VSPECIFICATION_Name:='Выключатель встраиваемый проходной СП31 1Р';
