unit DEVICE_VEL_SOCKET_1P40BUS;
...
BTY_TreeCoord:='PLAN_VEL_Розетки_Розетка BUS40 1Р';
...
VSPECIFICATION_Name:='Розетка напольная BUS40 1Р';
