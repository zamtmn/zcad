unit DEVICE_VEL_SOCKET_3F31OUT;
...
BTY_TreeCoord:='PLAN_VEL_Розетки_Розетка ОП31 1Р 3х фазная';
...
realnamedev:='Розетка ОП31 1Р 3F';
Power:=0.06;
CosPHI:=0.8;
...
VSPECIFICATION_Name:='Розетка ОП31 1Р ~380V';
