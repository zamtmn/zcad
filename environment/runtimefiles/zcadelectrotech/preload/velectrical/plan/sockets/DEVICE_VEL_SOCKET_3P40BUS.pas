unit DEVICE_VEL_SOCKET_3P40BUS;
...
BTY_TreeCoord:='PLAN_VEL_Розетки_Розетка BUS40 3Р';
...
VSPECIFICATION_Name:='Розетка напольная BUS40 3Р';
