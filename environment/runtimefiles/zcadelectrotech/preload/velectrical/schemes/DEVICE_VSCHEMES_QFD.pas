...
begin
BTY_TreeCoord:='PLAN_VEL_Схемы_АВДТ';

VSCHEMAUGOtext:='??\P??\P??';
VSPECIFICATION_Position:='QFD';
VSPECIFICATION_Name:='Автоматический выключатель дифференциального тока';
